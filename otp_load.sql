...
-- 1. staging table (heap DDL for mstr_psql COPY; uncomment and use 2.1 instead of 2.2)
...
-- 2. load OTP into air_oai_facts.airline_flight_performance_fdw
...
--OPTIONS (files 's3://src-aviation/OTP/CSV/On_Time_Reporting_Carrier_On_Time_Performance_1987_present_1987_10.csv.gz');
OPTIONS (files 's3://src-aviation/OTP/CSV/*.csv.gz');
